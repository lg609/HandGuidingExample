...
public:
    ...
    void setCalibrationPose(int index, double joint_angle[]);
    ...
    double getPerformanceIndex(const RVector q, RMatrix& Jt_inv, JACOBIAN_TYPE type = TRAN_J);
    ...
    void setHandGuidingSwitchIO(const std::string& IO_name__)/*{IO_name_ = IO_name__;}*/;

    void setHandGuidingMaxVel(const double value);
    void setHandGuidingMaxRot(const double value);
    ...
    static double s_pose1_calibration[CARTESIAN_FREEDOM];
    static double s_pose2_calibration[CARTESIAN_FREEDOM];
    static double s_pose3_calibration[CARTESIAN_FREEDOM];
